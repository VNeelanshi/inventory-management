      ...
      <TransitionGroup name="restock-slide" tag="div">
        ...
        >
          <div class="restock-order-left">
            ...
            <div class="restock-order-date">
              {{ formatDate(order.submitted_at) }}
            </div>
          </div>
          <div class="restock-order-middle">
            <div class="restock-item-count">
              {{ order.items.length }} item{{
                order.items.length !== 1 ? "s" : ""
              }}
            </div>
            <div class="restock-item-names">
              {{
                order.items
                  .slice(0, 3)
                  .map((i) => i.name)
          ...
          <div class="restock-order-right">
            ...
            <div class="restock-lead">
              ~{{ getLeadDays(order) }} days lead time
            </div>
            <div class="restock-delivery">
              Est. delivery: {{ formatDelivery(order.estimated_delivery) }}
            </div>
          </div>
        </div>
      </TransitionGroup>
